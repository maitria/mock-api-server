...
void function () {
  var buildResponseMap, buildStaticResponseEntry, cache$, each, entryAllowedForRequest, filter, patternMatcher, size, sortBy, stripExtension, url;
  ...
  buildStaticResponseEntry = function (filename, content) {
    var cache$1, path, pathname, query;
