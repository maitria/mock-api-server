...
void function () {
  var cache$, express, loadJsonFiles, lumber, MockApiServer, pick, Responder, ResponseSpecification;
  ...
  MockApiServer = function () {
    ...
    MockApiServer.prototype.start = function (done) {
      ...
      return loadJsonFiles('test/mock-api', function (this$) {
        return function (err, hash) {
          this$.responder = new Responder(hash);
    ...
    MockApiServer.prototype.respondTo = function (path) {
      this.dsl_path = path;
      return this;
    };
    MockApiServer.prototype['with'] = function (what) {
      var spec;
