...
void function () {
  ...
  Responder = function () {
    ...
    Responder.prototype.respondTo = function (request) {
      var allowedEntries, contentTransform, response, status;
    ...
    Responder.prototype._buildResponseMap = function (fsHash) {
      ...
      specs = map(fsHash, function (this$) {
        return function (response, filename) {
          var body, cache$1, status;
          cache$1 = response;
          body = cache$1.body;
          status = cache$1.status;
          return this$._buildStaticResponseEntry(filename, body, status);
        };
      }(this));
      return this._sortSpecs(specs);
    };
    ...
    Responder.prototype._buildStaticResponseEntry = function (filename, content, status) {
