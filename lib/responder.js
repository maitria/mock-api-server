...
void function () {
  var cache$, each, extend, filter, patternMatcher, Responder, ResponseSpecification, size, sortBy, url;
  ...
  ResponseSpecification = function () {
    function ResponseSpecification(param$) {
      ...
      this.path = this._stripExtension(this.path);
    }
    ...
    ResponseSpecification.prototype._stripExtension = function (path) {
