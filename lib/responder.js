  ...
  Responder = function () {
    ...
    Responder.prototype.respondTo = function (request) {
      ...
      if (allowedEntries.length === 0)
        return;
      contentTransform = function (content) {
        return content;
      };
      response = void 0;
      each(allowedEntries, function (entry) {
        ...
        if (typeof entry.content === 'function') {
          ...
          return contentTransform = function (content) {
            return entry.content(oldTransform(content));
          };
