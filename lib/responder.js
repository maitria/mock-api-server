...
void function () {
  var buildResponseMap, buildStaticResponseEntry, cache$, each, entryAllowedForRequest, extractMethod, filter, patternMatcher, Responder, size, sortBy, stripExtension, url;
