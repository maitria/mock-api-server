...
void function () {
  var cache$, express, HELP_MESSAGE, loadJsonFiles, lumber, mockApiServer, pick, Responder, ResponseSpecification, Server;
    ...
    Server.prototype.start = function (done) {
      ...
      return loadJsonFiles('test/mock-api', function (this$) {
        return function (err, hash) {
          var endpoint, hashWithBodyAndStatus, responseBody;
          hashWithBodyAndStatus = {};
          for (endpoint in hash) {
            responseBody = hash[endpoint];
            hashWithBodyAndStatus[endpoint] = {
              status: 200,
              body: responseBody
            };
          }
          this$.originalResponder = this$.responder = new Responder(hashWithBodyAndStatus);
