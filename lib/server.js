...
void function () {
  var express, HELP_MESSAGE, loadJsonFiles, lumber, mockApiServer, pick, Responder, Server;
  ...
  Server = function () {
    function Server(param$) {
      ...
      this._addResponseSpecification = function (a) {
        return Server.prototype._addResponseSpecification.apply(instance$, arguments);
      };
      this.argv = param$;
    }
    ...
    Server.prototype._addResponseSpecification = function (spec) {
